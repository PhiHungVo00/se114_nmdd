...
class Firm(db.Model):
    ...
    def __init__(self, name, description, thumbnail, start_date, end_date: None, rating_count=0, rating=0.0):
        self.name = name
    ...
    def serialize_detail(self):
        return {
            ...
            'Broadcasts': [broadcast.serialize() for broadcast in self.broadcasts]
        }
